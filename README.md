...
<a href="https://dotfyle.com/Zlatovlaska11/neovim"><img src="https://dotfyle.com/Zlatovlaska11/neovim/badges/plugin-manager?style=flat" /></a>
...
```sh
git clone git@github.com:Zlatovlaska11/neovim ~/.config/Zlatovlaska11/neovim
```

Open Neovim with this config:

```sh
NVIM_APPNAME=Zlatovlaska11/neovim/ nvim
```
